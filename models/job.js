...
class Job {
    /** Create a job (from data), update db, return job data.
     * 
     ...
     * 
     * This is a "partial update" - it is fine if data does not contain all the 
    ...
    /** Filter jobs by title, minSalary, hasEquity, or companyHandle
     * 
     * Returns [{ id, title, salary, equity, companyHandle }, ...]
     */
